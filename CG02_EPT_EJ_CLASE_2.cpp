...
Este código muestra el pixel art del símbolo de la trifuerza de La Leyenda de Zelda.
*/
...
void InitGL(GLvoid)     // Inicializamos parametros
{
	...
	glClearColor(1.0f, 1.0f, 0.0f, 0.0f);				// Negro de fondo
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	//Poner aquí código para dibujar.
	...
	glVertex3f(-8.0, 3.0f, -1.0f);
	glEnd();

	glBegin(GL_QUADS);
	glColor3f(0, 0, 0);
	glVertex3f(-9.0, 5.0f, -1.0);
	glVertex3f(-9.0, 3.0f, -1.0);
	glVertex3f(-7.0, 3.0f, -1.0);
	...
	glBegin(GL_QUADS);
	glVertex3f(-6.9f, 11.0f, -1.0f);
	glVertex3f(-6.9f, 9.0f, -1.0f);
	glVertex3f(-5.0f, 9.0f, -1.0f);
...
int main(int argc, char** argv)   // Main Function
{
	...
	glutCreateWindow("Ejercicio enClase 2"); // Nombre de la Ventana
